        ...
        <div class="card shadow col-lg-6">
            ...
            <form id="categoryForm" class="p-3" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ old('name', $category->name) }}" name="name" class="form-control fs" id="name" placeholder="Enter category name">
                </div>
                <button type="submit" class="btn btn-primary fs">Update</button>
            </form>
        </div>
    </div>
        ...
        $(document).ready(function () {
            ...
            $('#categoryForm').on('submit', function(e){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "{{ route('updateCategory', $category->token) }}",
                    statusCode: { 
                        404: function() { 
                            alert('404')
                        }, 
